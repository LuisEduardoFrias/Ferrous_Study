...
export default function FerrisIcon(props: Props) {
    ...
    >
      <g id="Layer-1">
        ...
        <g transform="matrix(-1.53e-05,-239.021,-239.021,1.53e-05,402.161,775.388)">
          <path d="M0.367,0.129C-0.364,-0.441 0.223,-0.711 0.223,-0.711C0.259,-0.391 0.472,-0.164 0.472,-0.164C0.521,-0.548 0.525,-0.77 0.525,-0.77C1.203,-0.256 0.589,0.161 0.589,0.161C0.627,0.265 0.772,0.372 0.906,0.451L1,0.77C0.376,0.403 0.367,0.129 0.367,0.129Z" fill="url(#_Linear3)" fillRule="nonzero" />
        </g>
      </g>
      <defs>
        <linearGradient id="_Linear1" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1,0,1.38778e-17,-1,0,-0.000650515)"><stop offset="0" stopColor="rgb(247,76,0)" stopOpacity="1" /><stop offset="0.33" stopColor="rgb(247,76,0)" stopOpacity="1" /><stop offset="1" stopColor="rgb(244,150,0)" stopOpacity="1" /></linearGradient>
        <linearGradient id="_Linear2" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1,0,0,-1,0,1.23438e-06)"><stop offset="0" stopColor="rgb(204,58,0)" stopOpacity="1" /><stop offset="0.15" stopColor="rgb(204,58,0)" stopOpacity="1" /><stop offset="0.74" stopColor="rgb(247,76,0)" stopOpacity="1" /><stop offset="1" stopColor="rgb(247,76,0)" stopOpacity="1" /></linearGradient>
        <linearGradient id="_Linear3" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1,1.32349e-23,1.32349e-23,-1,0,-9.1568e-07)"><stop offset="0" stopColor="rgb(204,58,0)" stopOpacity="1" /><stop offset="0.15" stopColor="rgb(204,58,0)" stopOpacity="1" /><stop offset="0.74" stopColor="rgb(247,76,0)" stopOpacity="1" /><stop offset="1" stopColor="rgb(247,76,0)" stopOpacity="1" /></linearGradient>
      </defs>
    </svg>
  );
}
...
<svg width="100%" height="100%" viewBox="0 0 1200 800" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
    <g id="Layer-1" serif:id="Layer 1">
        ...
        <g transform="matrix(1,0,0,1,520.766,436.428)">
            ...
            <circle cx="-36" cy="-10" r="3" fill="black"/>
        </g>
        <g transform="matrix(-1.53e-05,-239.021,-239.021,1.53e-05,402.161,775.388)">
